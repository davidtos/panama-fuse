...
public class fuse_args {
    ...
    static final VarHandle argc$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("argc"));
    ...
    public static MemoryAddress argv$get(MemorySegment seg) {
        return (MemoryAddress)fuse_args.argv$VH.get(seg);
    }
    ...
    public static MemoryAddress argv$get(MemorySegment seg, long index) {
        return (MemoryAddress)fuse_args.argv$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void argv$set(MemorySegment seg, long index, MemoryAddress x) {
        fuse_args.argv$VH.set(seg.asSlice(index*sizeof()), x);
    }
    static final VarHandle allocated$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("allocated"));
