...
public class tm {
    ...
    static final VarHandle tm_sec$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("tm_sec"));
    ...
    static final VarHandle tm_min$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("tm_min"));
    ...
    static final VarHandle tm_hour$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("tm_hour"));
    ...
    static final VarHandle tm_mday$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("tm_mday"));
    ...
    static final VarHandle tm_mon$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("tm_mon"));
    ...
    static final VarHandle tm_year$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("tm_year"));
    ...
    static final VarHandle tm_wday$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("tm_wday"));
    ...
    static final VarHandle tm_yday$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("tm_yday"));
    ...
    static final VarHandle tm_isdst$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("tm_isdst"));
    ...
    static final VarHandle tm_gmtoff$VH = $struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("tm_gmtoff"));
    ...
    static final VarHandle tm_zone$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("tm_zone")));
    public static VarHandle tm_zone$VH() {
        return tm.tm_zone$VH;
    }
    public static MemoryAddress tm_zone$get(MemorySegment seg) {
        return (MemoryAddress)tm.tm_zone$VH.get(seg);
    }
    ...
    public static MemoryAddress tm_zone$get(MemorySegment seg, long index) {
        return (MemoryAddress)tm.tm_zone$VH.get(seg.asSlice(index*sizeof()));
    }
