...
public class fuse_conn_info {
    ...
    static final VarHandle max_read$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("max_read"));
    ...
    static final VarHandle time_gran$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("time_gran"));
