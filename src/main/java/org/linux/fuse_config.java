...
public class fuse_config {
    ...
    static final MemoryLayout $struct$LAYOUT = MemoryLayout.structLayout(
        C_INT.withName("set_gid"),
        C_INT.withName("gid"),
        C_INT.withName("set_uid"),
        C_INT.withName("uid"),
        C_INT.withName("set_mode"),
        C_INT.withName("umask"),
        C_DOUBLE.withName("entry_timeout"),
        C_DOUBLE.withName("negative_timeout"),
        C_DOUBLE.withName("attr_timeout"),
        C_INT.withName("intr"),
        C_INT.withName("intr_signal"),
        C_INT.withName("remember"),
        C_INT.withName("hard_remove"),
        C_INT.withName("use_ino"),
        C_INT.withName("readdir_ino"),
        C_INT.withName("direct_io"),
        C_INT.withName("kernel_cache"),
        C_INT.withName("auto_cache"),
        C_INT.withName("ac_attr_timeout_set"),
        C_DOUBLE.withName("ac_attr_timeout"),
        C_INT.withName("nullpath_ok"),
        C_INT.withName("show_help"),
        C_POINTER.withName("modules"),
    ...
    static final VarHandle set_gid$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("set_gid"));
    ...
    static final VarHandle set_uid$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("set_uid"));
    ...
    static final VarHandle set_mode$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("set_mode"));
    ...
    static final VarHandle entry_timeout$VH = $struct$LAYOUT.varHandle(double.class, MemoryLayout.PathElement.groupElement("entry_timeout"));
    ...
    static final VarHandle negative_timeout$VH = $struct$LAYOUT.varHandle(double.class, MemoryLayout.PathElement.groupElement("negative_timeout"));
    ...
    static final VarHandle attr_timeout$VH = $struct$LAYOUT.varHandle(double.class, MemoryLayout.PathElement.groupElement("attr_timeout"));
    ...
    static final VarHandle intr$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("intr"));
    ...
    static final VarHandle intr_signal$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("intr_signal"));
    ...
    static final VarHandle remember$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("remember"));
    ...
    static final VarHandle hard_remove$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("hard_remove"));
    ...
    static final VarHandle use_ino$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("use_ino"));
    ...
    static final VarHandle readdir_ino$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("readdir_ino"));
    ...
    static final VarHandle direct_io$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("direct_io"));
    ...
    static final VarHandle kernel_cache$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("kernel_cache"));
    ...
    static final VarHandle auto_cache$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("auto_cache"));
    ...
    static final VarHandle ac_attr_timeout_set$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("ac_attr_timeout_set"));
    ...
    static final VarHandle ac_attr_timeout$VH = $struct$LAYOUT.varHandle(double.class, MemoryLayout.PathElement.groupElement("ac_attr_timeout"));
    ...
    static final VarHandle nullpath_ok$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("nullpath_ok"));
    ...
    static final VarHandle show_help$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("show_help"));
    ...
    static final VarHandle modules$VH = MemoryHandles.asAddressVarHandle($struct$LAYOUT.varHandle(long.class, MemoryLayout.PathElement.groupElement("modules")));
    public static VarHandle modules$VH() {
        return fuse_config.modules$VH;
    }
    public static MemoryAddress modules$get(MemorySegment seg) {
        return (MemoryAddress)fuse_config.modules$VH.get(seg);
    }
    ...
    public static MemoryAddress modules$get(MemorySegment seg, long index) {
        return (MemoryAddress)fuse_config.modules$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle debug$VH = $struct$LAYOUT.varHandle(int.class, MemoryLayout.PathElement.groupElement("debug"));
